...
civics: [
            ...
            },
 {
      ...
      book: "Book 4 Sem 1",
      units: [
        { name: "單元 1：家鄉的地形與環境", tags: ["社會", "小四", "地理", "台灣地形", "地形成因", "等高線"], topics: ["地形類型", "地形成因", "地形特徵"] },
        { name: "單元 2：變幻莫測的氣候與生活", tags: ["社會", "小四", "地理", "台灣氣候", "季風影響", "預期心理"], topics: ["氣候型態", "天氣變化", "生活影響"] },
        { name: "單元 3：原住民族的傳統與傳承", tags: ["社會", "小四", "文化", "原住民族", "祭典儀式", "多元文化"], topics: ["族群分布", "文化特色", "傳承智慧"] },
        { name: "單元 4：早期台灣：荷西時期與國際接軌", tags: ["社會", "小四", "歷史", "荷西時期", "國際貿易", "殖民影響"], topics: ["殖民概況", "遺跡考察", "國際分工"] },
        { name: "單元 5：我是公民：權利與責任的開始", tags: ["社會", "小四", "公民", "基本權利", "平等權", "公平正義"], topics: ["權利概念", "責任對應", "憲法保障"] },
        { name: "單元 6：政府的組成與公共服務", tags: ["社會", "小四", "公民", "政府運作", "公共政策", "地方政府"], topics: ["行政機關", "公共服務", "地方與中央"] }
      ]
    },
    {
      id: "soc_e4_s2",
      ...
      book: "Book 4 Sem 2",
      units: [
        { name: "單元 1：家鄉產業的特色與選擇", tags: ["社會", "小四", "地理", "在地產業", "資源利用", "生產決策"], topics: ["區域產業", "市場定位", "觀光發展"] },
        { name: "單元 2：清朝統治下的社會樣貌", tags: ["社會", "小四", "歷史", "清朝統治", "開墾社會", "渡臺禁令"], topics: ["統治政策", "社會變遷", "漢人移民"] },
        { name: "單元 3：日本統治與現代化的腳步", tags: ["社會", "小四", "歷史", "日本統治", "基礎建設", "現代化"], topics: ["教育普及", "守時觀念", "殖民影響"] },
        { name: "單元 4：團體生活與法治觀念", tags: ["社會", "小四", "公民", "規則與法律", "守法意識", "自律他律"], topics: ["法規概念", "團體規範", "生活法治"] },
        { name: "單元 5：永續家園：環境保護實踐", tags: ["社會", "小四", "環境", "環境保護", "生態保育", "政策工具"], topics: ["資源回收", "環境倫理", "綠色生活"] },
        { name: "單元 6：深耕社區：做個負責任的小公民", tags: ["社會", "小四", "公民", "社區參與", "公共倫理", "公民素養"], topics: ["社區營造", "志願服務", "校園參與"] }
      ]
    },
    {
      id: "soc_e5_s1",
      ...
      book: "Book 5 Sem 1",
      units: [
        { name: "單元 1：人地互動：地形氣候的綜合挑戰", tags: ["社會", "小五", "地理", "人地互動", "災害防治", "資源稀少性"], topics: ["地形氣候綜合", "環境經濟", "自然環境"] },
        { name: "單元 2：經濟活動的核心：產業發展與轉型", tags: ["社會", "小五", "經濟", "產業發展", "機會成本", "比較優勢"], topics: ["利潤分析", "勞動市場", "產業轉型"] },
        { name: "單元 3：串聯時空：台灣歷史綜合發展", tags: ["社會", "小五", "歷史", "歷史綜合", "時間線", "貨幣演進"], topics: ["時代脈絡", "歷史因果", "演進過程"] },
        { name: "單元 4：數位時代：科技、現代社會與生活", tags: ["社會", "小五", "現代", "科技應用", "資訊安全", "媒體識讀"], topics: ["科技生活", "社會變遷", "支付工具"] },
        { name: "單元 5：生活法律家：法律應用與救濟", tags: ["社會", "小五", "公民", "法律應用", "消費者保護", "權利救濟"], topics: ["法律案例", "民刑法基礎", "定型化契約"] },
        { name: "單元 6：認識中央政府與民主政治", tags: ["社會", "小五", "公民", "政府認識", "中央銀行", "選舉參與"], topics: ["國家職能", "福利政策", "預算租稅"] }
      ]
    },
    {
      id: "soc_e5_s2",
      ...
      book: "Book 5 Sem 2",
      units: [
        { name: "單元 1：家鄉資源圖譜：地理綜合運用", tags: ["社會", "小五", "地理", "區域特色", "資源分配", "交通運輸"], topics: ["台灣地理綜合", "國土利用", "地圖閱讀"] },
        { name: "單元 2：全球化視野下的現代文化與特色", tags: ["社會", "小五", "文化", "現代特色", "全球化", "文化敏感度"], topics: ["文化融合", "文化衝突", "異國交流"] },
        { name: "單元 3：權利與義務：保障與社會責任", tags: ["社會", "小五", "公民", "公民權利", "弱勢保障", "媒體責任"], topics: ["人權保障", "社會責任", "法律扶助"] },
        { name: "單元 4：政府體制：權力制衡與地方自治", tags: ["社會", "小五", "公民", "政府制度", "五權分立", "反托拉斯"], topics: ["地方自治", "制度架構", "政治參與"] },
        { name: "單元 5：隱形的約束：社會規範與倫理", tags: ["社會", "小五", "公民", "社會規範", "倫理道德", "社會保險"], topics: ["規範形成", "宗教風俗", "法律強制力"] },
        { name: "單元 6：史料探索：歷史事件的前因後果", tags: ["社會", "小五", "歷史", "史料閱讀", "歷史證據", "因果關係"], topics: ["重要事件整理", "脈絡判斷", "證據觀察"] }
      ]
    },
    {
      id: "soc_e6_s1",
      ...
      book: "Book 6 Sem 1",
      units: [
        { name: "單元 1：永續未來：地理空間與全球資源", tags: ["社會", "小六", "地理", "空間思考", "永續發展", "資源配置"], topics: ["資源永續", "全球議題", "環境保育"] },
        { name: "單元 2：穿透時空：進階史料分析與判讀", tags: ["社會", "小六", "歷史", "史料分析", "批判思考", "史實辯證"], topics: ["時代比較", "歷史解釋", "證據效力"] },
        { name: "單元 3：民主深耕：公民參與與公共議題", tags: ["社會", "小六", "公民", "民主參與", "政策理解", "誘因設計"], topics: ["權利義務深化", "行動方案", "公共政策"] },
        { name: "單元 4：經濟萬花筒：產業、職業與全球貿易", tags: ["社會", "小六", "經濟", "產業結構", "市場勞動", "匯率影響"], topics: ["職業世界", "區域比較", "宏觀經濟"] },
        { name: "單元 5：當代顯微鏡：社會議題深度思考", tags: ["社會", "小六", "現代", "社會議題", "人口老化", "失業定義"], topics: ["環境爭議", "貧富差距", "勞資關係"] },
        { name: "單元 6：台灣社會總整理：地理歷史公民的整合", tags: ["社會", "小六", "綜合", "在地認識", "總體經濟", "台灣價值"], topics: ["跨領域整合", "未來展望", "地位發展"] }
      ]
    },
    {
      id: "soc_e6_s2",
      ...
      book: "Book 6 Sem 2",
      units: [
        { name: "單元 1：地圖與數據：家鄉的空間分析實作", tags: ["社會", "小六", "地理", "地圖應用", "數據應用", "比例尺"], topics: ["空間分析", "座標定位", "實地考察"] },
        { name: "單元 2：歷史的思辨：史料運用與專題論述", tags: ["社會", "小六", "歷史", "史料運用", "歷史論述", "小論文"], topics: ["觀點比較", "證據分析", "歷史寫作"] },
        { name: "單元 3：公民行動：權利行使與專案參與", tags: ["社會", "小六", "公民", "公民參與實作", "請願訴願", "社會實踐"], topics: ["行動方案", "公共利益", "專案執行"] },
        { name: "單元 4：政策與經濟：公共議題的深度剖析", tags: ["社會", "小六", "公民", "政策案例分析", "決策理論", "公平交易"], topics: ["公共議題", "反托拉斯", "市場競爭"] },
        { name: "單元 5：社會微調查：問題解決與溝通", tags: ["社會", "小六", "現代", "社會調查", "問卷分析", "訪談技巧"], topics: ["問題解決", "調查研究", "社會倫理"] },
        { name: "單元 6：台灣與世界：整合與展望", tags: ["社會", "小六", "綜合", "跨學科", "國際局勢", "永續發展"], topics: ["地理歷史公民整合", "在地認識", "匯率影響"] }
      ]
    }
]
 };
