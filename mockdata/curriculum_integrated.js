...
civics: [
  ...
  {
    id: "soc_e4_s1", name: "小四社會 (上)", stage: "elementary", subject: "social", book: "Book 4 Sem 1",
    units: [
      { 
        name: "單元 1：台灣地形與氣候", 
        tags: ["小四", "地理", "台灣地形", "台灣氣候", "地形成因", "氣候特徵", "地形與人類活動"], 
        topics: ["地形類型", "氣候型態"] 
      },
      { 
        name: "單元 2：原住民族與文化特色", 
        tags: ["小四", "文化", "原住民族", "族群分布", "文化特色", "在地文化"], 
        topics: ["族群分布", "文化傳承"] 
      },
      { 
        name: "單元 3：荷西時期與國際貿易", 
        tags: ["小四", "歷史", "荷西時期", "國際貿易", "遺跡考察", "時代脈絡"], 
        topics: ["殖民概況", "外來影響"] 
      },
      { 
        name: "單元 4：基本權利與政府運作", 
        tags: ["小四", "公民", "基本權利", "政府運作", "權利義務", "公共服務"], 
        topics: ["基本權利", "政府職能"] 
      }
    ]
  },
  {
    id: "soc_e4_s2", name: "小四社會 (下)", stage: "elementary", subject: "social", book: "Book 4 Sem 2",
    units: [
      { 
        name: "單元 1：清朝統治與社會變遷", 
        tags: ["小四", "歷史", "清朝統治", "社會變遷", "時代脈絡", "因果關係"], 
        topics: ["統治政策", "移民社會"] 
      },
      { 
        name: "單元 2：日本統治與現代化發展", 
        tags: ["小四", "歷史", "現代", "日本統治", "現代化", "現代發展"], 
        topics: ["現代化足跡", "殖民政策"] 
      },
      { 
        name: "單元 3：規則、法律與公民生活", 
        tags: ["小四", "公民", "規則與法律", "公民生活", "守法意識", "權利義務"], 
        topics: ["法規概念", "團體規範"] 
      },
      { 
        name: "單元 4：地區特色、產業與環境", 
        tags: ["小四", "地理", "經濟", "環境", "地區特色與產業", "在地產業", "資源利用", "環境保護", "生態保育", "資源回收"], 
        topics: ["區域產業", "永續生活"] 
      }
    ]
  },
  {
    id: "soc_e5_s1", name: "小五社會 (上)", stage: "elementary", subject: "social", book: "Book 5 Sem 1",
    units: [
      { 
        name: "單元 1：地形氣候與地理綜合", 
        tags: ["小五", "地理", "台灣地形", "台灣氣候", "地形成因", "氣候特徵", "地形氣候綜合", "地形與人類活動"], 
        topics: ["自然環境綜整", "地理分佈"] 
      },
      { 
        name: "單元 2：產業發展與經濟活動", 
        tags: ["小五", "經濟", "產業發展", "在地產業", "地區特色與產業", "區域產業", "資源利用"], 
        topics: ["經濟轉型", "產業類型"] 
      },
      { 
        name: "單元 3：歷史脈絡與綜合探討", 
        tags: ["小五", "歷史", "歷史綜合", "時代脈絡", "因果關係", "史料閱讀"], 
        topics: ["歷史架構", "事件因果"] 
      }
    ]
  },
  {
    id: "soc_e5_s2", name: "小五社會 (下)", stage: "elementary", subject: "social", book: "Book 5 Sem 2",
    units: [
      { 
        name: "單元 1：現代社會與科技應用", 
        tags: ["小五", "現代", "現代社會", "現代特色", "科技應用", "現代發展"], 
        topics: ["科技生活", "社會變遷"] 
      },
      { 
        name: "單元 2：政府制度、法律與權利救濟", 
        tags: ["小五", "公民", "政府制度", "公民權利", "政府運作", "權利救濟", "守法意識"], 
        topics: ["法律保障", "政治體制"] 
      },
      { 
        name: "單元 3：多元文化與在地特色", 
        tags: ["小五", "文化", "在地文化", "文化特色", "現代特色"], 
        topics: ["文化融合", "區域特色"] 
      }
    ]
  },
  {
    id: "soc_e6_s1", name: "小六社會 (上)", stage: "elementary", subject: "social", book: "Book 6 Sem 1",
    units: [
      { 
        name: "單元 1：地理進階與地質作用", 
        tags: ["小六", "地理", "地質作用", "地形與人類活動", "永續發展"], 
        topics: ["地質變化", "空間分析"] 
      },
      { 
        name: "單元 2：民主參與與政府政策", 
        tags: ["小六", "公民", "民主參與", "政府制度", "公民權利", "公共服務"], 
        topics: ["民主參與", "政策理解"] 
      },
      { 
        name: "單元 3：史料分析進階", 
        tags: ["小六", "歷史", "史料分析", "因果關係", "時代脈絡"], 
        topics: ["史學方法", "批判思考"] 
      }
    ]
  },
  {
    id: "soc_e6_s2", name: "小六社會 (下)", stage: "elementary", subject: "social", book: "Book 6 Sem 2",
    units: [
      { 
        name: "單元 1：現代社會議題與永續", 
        tags: ["小六", "現代", "環境", "現代社會", "永續發展", "環境保護", "生態保育"], 
        topics: ["全球議題", "永續未來"] 
      },
      { 
        name: "單元 2：公民行動與權利行使", 
        tags: ["小六", "公民", "公民生活", "民主參與", "公民權利", "權利義務"], 
        topics: ["行動方案", "權利保障"] 
      }
    ]
  }
