...
civics: [
  ...
  },
  {
...

    {
      ...
      book: "Book 4 Sem 1",
      units: [
        { name: "單元 1：台灣地形 — 山海河流的家鄉地圖", tags: ["社會","小四","地理"], topics: ["地形類型","地形成因"] },
        { name: "單元 2：台灣氣候 — 四季與天氣的小秘密", tags: ["社會","小四","地理"], topics: ["氣候型態","季風影響"] },
        { name: "單元 3：原住民族 — 傳統與文化的故事", tags: ["社會","小四","文化"], topics: ["族群分布","文化特色"] },
        { name: "單元 4：荷西時期 — 歷史上的外國來客", tags: ["社會","小四","歷史"], topics: ["殖民概況","影響與遺跡"] },
        { name: "單元 5：基本權利 — 我有權利也有責任", tags: ["社會","小四","公民"], topics: ["權利概念","責任對應"] },
        { name: "單元 6：政府運作 — 政府怎麼幫助大家？", tags: ["社會","小四","公民"], topics: ["地方與中央","公共服務"] }
      ]
    },
    {
      id: "soc_e4_s2",
      ...
      book: "Book 4 Sem 2",
      units: [
        { name: "單元 1：地區特色與產業 — 各地有各地的好味道", tags: ["社會","小四","地理"], topics: ["區域產業","資源利用"] },
        { name: "單元 2：清朝統治 — 歷史的變化與生活樣貌", tags: ["社會","小四","歷史"], topics: ["統治政策","社會變遷"] },
        { name: "單元 3：日本統治 — 現代化的足跡", tags: ["社會","小四","歷史"], topics: ["殖民影響","現代化"] },
        { name: "單元 4：現代發展 — 城市與交通的變化", tags: ["社會","小四","現代"], topics: ["都市化","交通發展"] },
        { name: "單元 5：規則與法律 — 為什麼要有規則？", tags: ["社會","小四","公民"], topics: ["法規概念","守法意識"] },
        { name: "單元 6：公民生活 — 做個負責任的小公民", tags: ["社會","小四","公民"], topics: ["社區參與","公共倫理"] }
      ]
    },
    {
      id: "soc_e5_s1",
      ...
      book: "Book 5 Sem 1",
      units: [
        { name: "單元 1：地形氣候綜合 — 人與環境的互動故事", tags: ["社會","小五","地理"], topics: ["地形與氣候互動","人地關係"] },
        { name: "單元 2：產業發展 — 家鄉的工作與經濟", tags: ["社會","小五","經濟"], topics: ["產業類型","產業演變"] },
        { name: "單元 3：歷史綜合 — 把時間線串起來", tags: ["社會","小五","歷史"], topics: ["時代脈絡","史料閱讀"] },
        { name: "單元 4：現代社會 — 科技如何改變生活？", tags: ["社會","小五","現代"], topics: ["科技與生活","社會變遷"] },
        { name: "單元 5：法律應用 — 法律在生活中的小案例", tags: ["社會","小五","公民"], topics: ["法律案例","權利義務"] },
        { name: "單元 6：政府認識 — 政府做了哪些事？", tags: ["社會","小五","公民"], topics: ["政府職能","選舉與參與"] }
      ]
    },
    {
      id: "soc_e5_s2",
      ...
      book: "Book 5 Sem 2",
      units: [
        { name: "單元 1：台灣地理綜合 — 看懂家鄉的地圖與資源", tags: ["社會","小五","地理"], topics: ["區域比較","資源分配"] },
        { name: "單元 2：歷史脈絡 — 重要事件的前因後果", tags: ["社會","小五","歷史"], topics: ["重要事件整理","因果關係"] },
        { name: "單元 3：公民權利 — 權利保障與社會責任", tags: ["社會","小五","公民"], topics: ["權利保障","社會責任"] },
        { name: "單元 4：政府制度 — 制度怎麼影響我們的生活", tags: ["社會","小五","公民"], topics: ["制度架構","地方自治"] },
        { name: "單元 5：社會規範 — 規範如何形成與改變", tags: ["社會","小五","公民"], topics: ["規範形成","倫理判斷"] },
        { name: "單元 6：現代特色 — 全球化與在地文化的交會", tags: ["社會","小五","現代"], topics: ["全球化影響","在地文化"] }
      ]
    },
    {
      id: "soc_e6_s1",
      ...
      book: "Book 6 Sem 1",
      units: [
        { name: "單元 1：地理進階 — 空間思考與資源永續", tags: ["社會","小六","地理"], topics: ["地形與人類活動","資源永續"] },
        { name: "單元 2：歷史進階 — 用史料看見過去的樣貌", tags: ["社會","小六","歷史"], topics: ["史料分析","時代比較"] },
        { name: "單元 3：公民進階 — 民主與參與的實作", tags: ["社會","小六","公民"], topics: ["權利義務深化","民主參與"] },
        { name: "單元 4：政府進階 — 政策如何影響生活", tags: ["社會","小六","公民"], topics: ["政府分工","政策理解"] },
        { name: "單元 5：社會議題 — 環境與社會問題的思考", tags: ["社會","小六","現代"], topics: ["環境議題","社會問題"] },
        { name: "單元 6：產業特色 — 了解區域經濟與職業世界", tags: ["社會","小六","經濟"], topics: ["產業結構","區域比較"] }
      ]
    },
    {
      id: "soc_e6_s2",
      ...
      book: "Book 6 Sem 2",
      units: [
        { name: "單元 1：地理應用 — 地圖與資料的實作練習", tags: ["社會","小六","地理"], topics: ["地圖應用","空間分析"] },
        { name: "單元 2：歷史應用 — 用史料寫小論述", tags: ["社會","小六","歷史"], topics: ["史料運用","歷史論述"] },
        { name: "單元 3：公民應用 — 公民參與的小專案", tags: ["社會","小六","公民"], topics: ["公民參與實作","權利行使"] },
        { name: "單元 4：政府應用 — 分析政策案例與公共議題", tags: ["社會","小六","公民"], topics: ["政策案例分析","公共議題"] },
        { name: "單元 5：社會應用 — 做一個小小社會調查", tags: ["社會","小六","現代"], topics: ["社會調查","問題解決"] },
        { name: "單元 6：台灣綜合 — 地理、歷史、公民的總整理", tags: ["社會","小六","綜合"], topics: ["地理歷史公民整合","在地認識"] }
      ]
    }
  ]
    };
