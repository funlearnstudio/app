(function(global){
  ...
  { unitId:"sustain", unitName:"永續發展與資源管理（延伸）", grade: "國九", t:["永續","資源","環境"],
    ...
    // --- 國七地理：台灣篇 ---
    { q: "台灣本島的最南端是哪一個岬角？", a: "鵝鑾鼻", o: ["三貂角", "富貴角", "鼻頭角"], t: ["地理", "國七", "台灣位置"] },
    { q: "台灣本島的最北端是哪一個岬角？", a: "富貴角", o: ["鵝鑾鼻", "三貂角", "好望角"], t: ["地理", "國七", "台灣位置"] },
    { q: "台灣五大山脈中，被稱為「台灣屋脊」，且主峰為台灣最高峰的是？", a: "玉山山脈", o: ["中央山脈", "雪山山脈", "阿里山山脈"], t: ["地理", "國七", "台灣地形"] },
    { q: "台灣島的形成，主要是哪兩個板塊相互擠壓造成的？", a: "歐亞板塊與菲律賓海板塊", o: ["歐亞板塊與太平洋板塊", "印澳板塊與太平洋板塊", "北美板塊與歐亞板塊"], t: ["地理", "國七", "台灣地質"] },
    { q: "台灣西南部沿海地區常見的「潟湖」與「沙洲」地形，最典型的例子是？", a: "台江內海(七股潟湖)", o: ["日月潭", "大鵬灣", "鯉魚潭"], t: ["地理", "國七", "海岸地形"] },
    { q: "台灣氣候上，降雨呈現「夏雨冬乾」，且冬季常有強風的地區主要是？", a: "西南部", o: ["東北部", "西北部", "東部"], t: ["地理", "國七", "台灣氣候"] },
    { q: "台灣北部冬季經常下雨，被稱為「竹風蘭雨」的蘭雨，主要是受什麼地形與季風影響？", a: "東北季風與迎風坡地形", o: ["西南季風與背風坡", "颱風與高氣壓", "梅雨與鋒面"], t: ["地理", "國七", "台灣氣候"] },
    { q: "台灣的河川具有「坡陡流急、洪枯水期明顯」的特徵，這主要是受到什麼影響？", a: "地形與降雨集中", o: ["植被稀少", "緯度較低", "土壤鬆軟"], t: ["地理", "國七", "台灣水文"] },
    { q: "台灣南部因降雨集中夏季，冬季常缺水，因此農業發展出哪一種特殊的儲水設施？", a: "埤塘與水庫", o: ["坎兒井", "海水淡化廠", "人工湖"], t: ["地理", "國七", "台灣水文"] },
    { q: "人口金字塔若呈現「底部寬、頂部尖」的形狀，代表該國人口呈現何種狀態？", a: "高出生率、高成長", o: ["高齡化、負成長", "低出生率、零成長", "勞動力極度缺乏"], t: ["地理", "國七", "人口特徵"] },
    { q: "一個國家的壯年人口負擔較重，通常是指哪兩種人口比例較高？", a: "幼年人口與老年人口", o: ["青年人口與中年人口", "男性人口與女性人口", "移入人口與移出人口"], t: ["地理", "國七", "人口扶養"] },
    { q: "台灣近年來產業結構轉變，目前產值與就業人口比例最高的是哪一級產業？", a: "第三級產業 (服務業)", o: ["第二級產業 (工業)", "第一級產業 (農林漁牧)", "第四級產業 (資訊業)"], t: ["地理", "國七", "台灣產業"] },
    { q: "台灣農業近年面臨加入WTO的衝擊，政府推動「精緻農業」與什麼農業來因應？", a: "休閒農業", o: ["粗放農業", "熱帶栽培業", "游耕"], t: ["地理", "國七", "台灣農業"] },
    { q: "為縮短台灣西部南北交通時間而興建的「台灣高鐵」，北起南港，南至何處？", a: "左營", o: ["屏東", "高雄車站", "台南"], t: ["地理", "國七", "台灣交通"] },
    { q: "台灣東部海岸主要屬於哪一種海岸類型，斷崖峭壁逼近海岸？", a: "斷層海岸", o: ["沙岸", "珊瑚礁海岸", "峽灣海岸"], t: ["地理", "國七", "台灣海岸"] },

    // --- 國八地理：中國、亞洲與大洋洲 ---
    { q: "中國的地形特徵為「西高東低」，呈三級階梯分佈。最高的第一級階梯主要為何處？", a: "青藏高原", o: ["雲貴高原", "黃土高原", "內蒙古高原"], t: ["地理", "國八", "中國地形"] },
    { q: "有「世界屋脊」之稱，且為長江、黃河發源地的高原是？", a: "青藏高原", o: ["帕米爾高原", "雲貴高原", "蒙古高原"], t: ["地理", "國八", "中國地形"] },
    { q: "中國氣候深受季風影響，夏季盛行東南季風，冬季盛行什麼季風？", a: "西北季風", o: ["東北季風", "西南季風", "東南季風"], t: ["地理", "國八", "中國氣候"] },
    { q: "中國北部著名的「黃土高原」，其黃土的來源主要是受到哪一種外營力搬運而來？", a: "風力", o: ["冰河", "河流", "波浪"], t: ["地理", "國八", "中國地形"] },
    { q: "中國南部常出現的「石灰岩地形」(喀斯特地形)，最著名的代表區域是？", a: "雲貴高原 (如桂林)", o: ["四川盆地", "長江中下游平原", "珠江三角洲"], t: ["地理", "國八", "中國地形"] },
    { q: "中南半島的氣候主要為何？", a: "熱帶季風氣候", o: ["熱帶雨林氣候", "熱帶沙漠氣候", "溫帶季風氣候"], t: ["地理", "國八", "東南亞"] },
    { q: "馬來群島的大部分地區，終年高溫多雨，屬於哪一種氣候？", a: "熱帶雨林氣候", o: ["熱帶季風氣候", "熱帶高地氣候", "副熱帶季風氣候"], t: ["地理", "國八", "東南亞"] },
    { q: "東南亞地區是全球最大的哪一種經濟作物產地？(泰國、印尼、馬來西亞為主)", a: "天然橡膠與棕櫚油", o: ["小麥與玉米", "棉花與甜菜", "蘋果與葡萄"], t: ["地理", "國八", "東南亞經濟"] },
    { q: "日本地處環太平洋火山地震帶，因此哪一種再生能源蘊藏豐富？", a: "地熱能", o: ["潮汐能", "風能", "生質能"], t: ["地理", "國八", "日本"] },
    { q: "南亞的印度半島，夏季主要受什麼風向的季風吹拂，帶來豐沛降雨？", a: "西南季風", o: ["東北季風", "西北季風", "東南季風"], t: ["地理", "國八", "南亞"] },
    { q: "南亞人口最多的國家，也是世界人口第一大國(2023年起)的是？", a: "印度", o: ["中國", "巴基斯坦", "孟加拉"], t: ["地理", "國八", "南亞"] },
    { q: "中東(西亞)地區最缺乏且容易引發戰爭的自然資源是？", a: "水資源", o: ["石油", "天然氣", "金礦"], t: ["地理", "國八", "西亞"] },
    { q: "阿拉伯半島大部分地區屬於哪一種氣候？", a: "熱帶沙漠氣候", o: ["熱帶草原氣候", "溫帶地中海型氣候", "高地氣候"], t: ["地理", "國八", "西亞"] },
    { q: "澳洲中西部廣大的地區主要為何種景觀？", a: "沙漠", o: ["熱帶雨林", "溫帶落葉林", "冰原"], t: ["地理", "國八", "大洋洲"] },
    { q: "紐西蘭的經濟支柱之一是畜牧業，北島以養牛為主，南島主要飼養？", a: "羊", o: ["馬", "豬", "駱駝"], t: ["地理", "國八", "大洋洲"] },

    // --- 國九地理：世界地理與全球議題 ---
    { q: "歐洲地形以阿爾卑斯山為界，以北主要是什麼地形？", a: "大平原", o: ["高原", "盆地", "高大山脈"], t: ["地理", "國九", "歐洲地形"] },
    { q: "歐洲氣候普遍較同緯度地區溫和，主要是受到哪一股暖流的影響？", a: "北大西洋暖流", o: ["黑潮暖流", "墨西哥灣暖流", "赤道暖流"], t: ["地理", "國九", "歐洲氣候"] },
    { q: "地中海型氣候的最大特徵為何？", a: "夏乾冬雨", o: ["全年有雨", "夏雨冬乾", "全年乾燥"], t: ["地理", "國九", "歐洲氣候"] },
    { q: "北美洲中部的「北美大平原」，冬季常遭受來自北極的暴風雪襲擊，主要是因為缺乏哪種走向的山脈阻擋？", a: "東西走向的山脈", o: ["南北走向的山脈", "東北走向的山脈", "西北走向的山脈"], t: ["地理", "國九", "北美洲"] },
    { q: "美國境內面積最大、長度最長的河流系統是？", a: "密西西比河", o: ["科羅拉多河", "聖羅倫斯河", "亞馬孫河"], t: ["地理", "國九", "北美洲"] },
    { q: "南美洲的安地斯山脈，是世界上哪一種特徵的山脈？", a: "世界最長的山脈", o: ["世界最高的山脈", "世界最古老的山脈", "世界最寬的山脈"], t: ["地理", "國九", "中南美洲"] },
    { q: "中南美洲因過去受到哪兩個國家的殖民，多數國家通用西班牙語或葡萄牙語？", a: "西班牙、葡萄牙", o: ["英國、法國", "荷蘭、德國", "義大利、比利時"], t: ["地理", "國九", "中南美洲"] },
    { q: "非洲有「黑暗大陸」之稱，地形主體以何種地形為主？", a: "高原", o: ["平原", "盆地", "高山"], t: ["地理", "國九", "非洲地形"] },
    { q: "尼羅河是世界最長的河流，它最終注入哪一個海？", a: "地中海", o: ["紅海", "黑海", "大西洋"], t: ["地理", "國九", "非洲水文"] },
    { q: "非洲赤道兩側最典型的氣候類型為何？", a: "熱帶雨林氣候", o: ["熱帶草原氣候", "熱帶沙漠氣候", "高地氣候"], t: ["地理", "國九", "非洲氣候"] },
    { q: "非洲熱帶草原氣候區最著名的景觀是？", a: "野生動物大遷徙", o: ["極光", "峽灣", "大面積針葉林"], t: ["地理", "國九", "非洲生態"] },
    { q: "導致溫室效應加劇，使全球暖化的主要溫室氣體是？", a: "二氧化碳", o: ["氧氣", "氮氣", "氫氣"], t: ["地理", "國九", "全球議題"] },
    { q: "「聖嬰現象」發生時，太平洋東側(南美洲秘魯沿海)的水溫會產生何種變化？", a: "異常升高", o: ["異常降低", "保持不變", "結冰"], t: ["地理", "國九", "全球氣候"] },
    { q: "因應全球氣候變遷，要求各國減少溫室氣體排放的國際協定，近年最著名的是？", a: "巴黎協定", o: ["蒙特婁議定書", "京都議定書(已過期)", "華盛頓公約"], t: ["地理", "國九", "國際公約"] },
    { q: "跨國企業為了降低生產成本，將工廠遷移至勞工便宜的國家，這種現象稱為？", a: "產業外移", o: ["產業升級", "貿易保護", "進口替代"], t: ["地理", "國九", "經濟全球化"] },
    // ==========================================
